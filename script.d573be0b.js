...
function makeElementMarkup(_ref) {
  var preview = _ref.preview,
      original = _ref.original,
      description = _ref.description;
  return "<li><a class=\"gallery__link\" href=".concat(original, "><img class=\"gallery__image\" src=").concat(preview, " data-source=").concat(original, " alt=").concat(description, "/></a></li>");
}

function addNewElementsMarkup() {
  refs.gallery.insertAdjacentHTML('beforeend', _galleryItems.default.map(makeElementMarkup).join(''));
}
